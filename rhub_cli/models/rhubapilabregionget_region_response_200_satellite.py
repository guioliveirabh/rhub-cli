...
class RhubapilabregiongetRegionResponse200Satellite:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabregionget_region_response_200_satellite = cls(
            credentials=credentials,
            hostname=hostname,
            insecure=insecure,
        )

        rhubapilabregionget_region_response_200_satellite.additional_properties = d
        return rhubapilabregionget_region_response_200_satellite
