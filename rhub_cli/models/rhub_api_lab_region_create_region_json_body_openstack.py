...
from ..models.rhub_api_lab_region_create_region_json_body_openstack_id import (
...
class RhubApiLabRegionCreateRegionJsonBodyOpenstack:
    ...
    Attributes:
        ...
        id (Union[Unset, RhubApiLabRegionCreateRegionJsonBodyOpenstackId]):
    ...
    id: Union[Unset, RhubApiLabRegionCreateRegionJsonBodyOpenstackId] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_id, Unset):
            ...
            id = RhubApiLabRegionCreateRegionJsonBodyOpenstackId.from_dict(_id)
