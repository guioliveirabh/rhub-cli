...
class RhubapilabproductgetProductResponse200FlavorsAdditionalProperty:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabproductget_product_response_200_flavors_additional_property = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabproductget_product_response_200_flavors_additional_property.additional_properties = d
        return rhubapilabproductget_product_response_200_flavors_additional_property
