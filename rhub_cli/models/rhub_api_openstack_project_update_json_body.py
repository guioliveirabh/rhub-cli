...
from ..models.rhub_api_openstack_project_update_json_body_id import RhubApiOpenstackProjectUpdateJsonBodyId
...
class RhubApiOpenstackProjectUpdateJsonBody:
    ...
    Attributes:
        ...
        id (Union[Unset, RhubApiOpenstackProjectUpdateJsonBodyId]):
    ...
    id: Union[Unset, RhubApiOpenstackProjectUpdateJsonBodyId] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_id, Unset):
            ...
            id = RhubApiOpenstackProjectUpdateJsonBodyId.from_dict(_id)
