...
from ..models.rhubapilabregionupdate_region_json_body_satellite_credentials_type_0 import RhubapilabregionupdateRegionJsonBodySatelliteCredentialsType0
...
class RhubapilabregionupdateRegionJsonBodySatellite:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        def _parse_credentials(data: object) -> Union[RhubapilabregionupdateRegionJsonBodySatelliteCredentialsType0, Unset, str]:
            ...
            try:
                ...
                if isinstance(_credentials_type_0,  Unset):
                    ...
                    credentials_type_0 = RhubapilabregionupdateRegionJsonBodySatelliteCredentialsType0.from_dict(_credentials_type_0)
