...
class RhubapilabregionlistRegionsResponse200DataItemOpenstack:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabregionlist_regions_response_200_data_item_openstack = cls(
        ...
        rhubapilabregionlist_regions_response_200_data_item_openstack.additional_properties = d
        return rhubapilabregionlist_regions_response_200_data_item_openstack
