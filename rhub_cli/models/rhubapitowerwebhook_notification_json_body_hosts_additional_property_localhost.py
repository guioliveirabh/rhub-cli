...
class RhubapitowerwebhookNotificationJsonBodyHostsAdditionalPropertyLocalhost:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapitowerwebhook_notification_json_body_hosts_additional_property_localhost = cls(
            changed=changed,
            dark=dark,
            failed=failed,
            failures=failures,
        ...
        rhubapitowerwebhook_notification_json_body_hosts_additional_property_localhost.additional_properties = d
        return rhubapitowerwebhook_notification_json_body_hosts_additional_property_localhost
