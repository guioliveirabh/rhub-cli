...
from ..models.rhub_api_openstack_project_get_response_200_id import RhubApiOpenstackProjectGetResponse200Id
...
class RhubApiOpenstackProjectGetResponse200:
    ...
    Attributes:
        ...
        id (Union[Unset, RhubApiOpenstackProjectGetResponse200Id]):
    ...
    id: Union[Unset, RhubApiOpenstackProjectGetResponse200Id] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_id, Unset):
            ...
            id = RhubApiOpenstackProjectGetResponse200Id.from_dict(_id)
