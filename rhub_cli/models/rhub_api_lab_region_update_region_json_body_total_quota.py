...
T = TypeVar("T", bound="RhubApiLabRegionUpdateRegionJsonBodyTotalQuota")


@attr.s(auto_attribs=True)
class RhubApiLabRegionUpdateRegionJsonBodyTotalQuota:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_update_region_json_body_total_quota = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_region_update_region_json_body_total_quota.additional_properties = d
        return rhub_api_lab_region_update_region_json_body_total_quota
