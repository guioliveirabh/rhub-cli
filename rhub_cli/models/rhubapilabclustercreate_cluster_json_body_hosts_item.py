...
from ..models.rhubapilabclustercreate_cluster_json_body_hosts_item_id import RhubapilabclustercreateClusterJsonBodyHostsItemId
from typing import Dict
from ..types import UNSET, Unset
from ..models.rhubapilabclustercreate_cluster_json_body_hosts_item_cluster_id import RhubapilabclustercreateClusterJsonBodyHostsItemClusterId
...
class RhubapilabclustercreateClusterJsonBodyHostsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclustercreate_cluster_json_body_hosts_item = cls(
        ...
        rhubapilabclustercreate_cluster_json_body_hosts_item.additional_properties = d
        return rhubapilabclustercreate_cluster_json_body_hosts_item
