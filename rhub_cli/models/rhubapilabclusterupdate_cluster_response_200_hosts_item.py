...
from ..models.rhubapilabclusterupdate_cluster_response_200_hosts_item_id import RhubapilabclusterupdateClusterResponse200HostsItemId
from typing import Dict
from ..types import UNSET, Unset
from ..models.rhubapilabclusterupdate_cluster_response_200_hosts_item_cluster_id import RhubapilabclusterupdateClusterResponse200HostsItemClusterId
...
class RhubapilabclusterupdateClusterResponse200HostsItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclusterupdate_cluster_response_200_hosts_item = cls(
        ...
        rhubapilabclusterupdate_cluster_response_200_hosts_item.additional_properties = d
        return rhubapilabclusterupdate_cluster_response_200_hosts_item
