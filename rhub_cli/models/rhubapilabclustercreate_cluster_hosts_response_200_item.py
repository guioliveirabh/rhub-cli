...
from ..models.rhubapilabclustercreate_cluster_hosts_response_200_item_cluster_id import (
    RhubapilabclustercreateClusterHostsResponse200ItemClusterId,
)
from ..models.rhubapilabclustercreate_cluster_hosts_response_200_item_id import (
...
class RhubapilabclustercreateClusterHostsResponse200Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclustercreate_cluster_hosts_response_200_item = cls(
        ...
        rhubapilabclustercreate_cluster_hosts_response_200_item.additional_properties = d
        return rhubapilabclustercreate_cluster_hosts_response_200_item
