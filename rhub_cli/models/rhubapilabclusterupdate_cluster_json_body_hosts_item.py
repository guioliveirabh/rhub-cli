...
from ..models.rhubapilabclusterupdate_cluster_json_body_hosts_item_cluster_id import (
    RhubapilabclusterupdateClusterJsonBodyHostsItemClusterId,
)
from ..models.rhubapilabclusterupdate_cluster_json_body_hosts_item_id import (
