...
from ..models.rhubapilabregionget_region_response_200_quota_type_0 import RhubapilabregiongetRegionResponse200QuotaType0
...
class RhubapilabregiongetRegionResponse200:
    ...
    Attributes:
        ...
        quota (Union[Any, RhubapilabregiongetRegionResponse200QuotaType0, Unset]):  Example: {'num_vcpus': 40,
    ...
    quota: Union[Any, RhubapilabregiongetRegionResponse200QuotaType0, Unset] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.quota, Unset):
            quota = UNSET
        elif isinstance(self.quota, RhubapilabregiongetRegionResponse200QuotaType0):
            quota = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def _parse_quota(data: object) -> Union[Any, RhubapilabregiongetRegionResponse200QuotaType0, Unset]:
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                _quota_type_0 = data
                quota_type_0: Union[Unset, RhubapilabregiongetRegionResponse200QuotaType0]
                if isinstance(_quota_type_0, Unset):
                    quota_type_0 = UNSET
                else:
                    quota_type_0 = RhubapilabregiongetRegionResponse200QuotaType0.from_dict(_quota_type_0)
