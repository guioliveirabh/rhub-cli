...
class RhubapilabproductlistProductRegionsFilter:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabproductlist_product_regions_filter = cls(
            enabled=enabled,
            location=location,
            name=name,
        ...
        rhubapilabproductlist_product_regions_filter.additional_properties = d
        return rhubapilabproductlist_product_regions_filter
