...
class RhubapitowerlistJobsResponse200DataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapitowerlist_jobs_response_200_data_item = cls(
        ...
        rhubapitowerlist_jobs_response_200_data_item.additional_properties = d
        return rhubapitowerlist_jobs_response_200_data_item
