...
class RhubapitowerlistTemplateJobsResponse200:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapitowerlist_template_jobs_response_200 = cls(
            data=data,
            total=total,
        )

        rhubapitowerlist_template_jobs_response_200.additional_properties = d
        return rhubapitowerlist_template_jobs_response_200
