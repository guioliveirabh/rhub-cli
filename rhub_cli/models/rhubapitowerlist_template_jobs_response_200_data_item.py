...
from ..models.rhubapitowerlist_template_jobs_response_200_data_item_id import RhubapitowerlistTemplateJobsResponse200DataItemId
...
class RhubapitowerlistTemplateJobsResponse200DataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapitowerlist_template_jobs_response_200_data_item = cls(
        ...
        rhubapitowerlist_template_jobs_response_200_data_item.additional_properties = d
        return rhubapitowerlist_template_jobs_response_200_data_item
