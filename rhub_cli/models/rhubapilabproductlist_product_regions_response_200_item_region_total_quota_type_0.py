...
class RhubapilabproductlistProductRegionsResponse200ItemRegionTotalQuotaType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabproductlist_product_regions_response_200_item_region_total_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabproductlist_product_regions_response_200_item_region_total_quota_type_0.additional_properties = d
        return rhubapilabproductlist_product_regions_response_200_item_region_total_quota_type_0
