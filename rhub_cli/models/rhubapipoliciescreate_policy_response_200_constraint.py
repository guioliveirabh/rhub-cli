...
from ..types import UNSET, Unset
from ..models.rhubapipoliciescreate_policy_response_200_constraint_limit import RhubapipoliciescreatePolicyResponse200ConstraintLimit
...
class RhubapipoliciescreatePolicyResponse200Constraint:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapipoliciescreate_policy_response_200_constraint = cls(
            cost=cost,
            density=density,
            limit=limit,
            location=location,
        ...
        rhubapipoliciescreate_policy_response_200_constraint.additional_properties = d
        return rhubapipoliciescreate_policy_response_200_constraint
