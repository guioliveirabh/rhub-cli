...
T = TypeVar("T", bound="RhubApiLabClusterUpdateClusterJsonBodyQuotaUsage")


@attr.s(auto_attribs=True)
class RhubApiLabClusterUpdateClusterJsonBodyQuotaUsage:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_cluster_update_cluster_json_body_quota_usage = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_cluster_update_cluster_json_body_quota_usage.additional_properties = d
        return rhub_api_lab_cluster_update_cluster_json_body_quota_usage
