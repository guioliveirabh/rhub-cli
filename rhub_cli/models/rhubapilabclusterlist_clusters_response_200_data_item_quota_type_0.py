...
class RhubapilabclusterlistClustersResponse200DataItemQuotaType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclusterlist_clusters_response_200_data_item_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabclusterlist_clusters_response_200_data_item_quota_type_0.additional_properties = d
        return rhubapilabclusterlist_clusters_response_200_data_item_quota_type_0
