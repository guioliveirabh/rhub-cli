...
from ..models.rhubapilabclusterlist_cluster_hosts_response_200_item_cluster_id import (
    RhubapilabclusterlistClusterHostsResponse200ItemClusterId,
)
from ..models.rhubapilabclusterlist_cluster_hosts_response_200_item_id import (
...
class RhubapilabclusterlistClusterHostsResponse200Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclusterlist_cluster_hosts_response_200_item = cls(
        ...
        rhubapilabclusterlist_cluster_hosts_response_200_item.additional_properties = d
        return rhubapilabclusterlist_cluster_hosts_response_200_item
