...
class RhubapilabclustercreateClusterResponse200QuotaUsageType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclustercreate_cluster_response_200_quota_usage_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabclustercreate_cluster_response_200_quota_usage_type_0.additional_properties = d
        return rhubapilabclustercreate_cluster_response_200_quota_usage_type_0
