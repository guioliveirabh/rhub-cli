...
from ..models.rhub_api_lab_region_update_region_json_body_openstack_id import (
...
class RhubApiLabRegionUpdateRegionJsonBodyOpenstack:
    ...
    Attributes:
        ...
        id (Union[Unset, RhubApiLabRegionUpdateRegionJsonBodyOpenstackId]):
    ...
    id: Union[Unset, RhubApiLabRegionUpdateRegionJsonBodyOpenstackId] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_id, Unset):
            ...
            id = RhubApiLabRegionUpdateRegionJsonBodyOpenstackId.from_dict(_id)
