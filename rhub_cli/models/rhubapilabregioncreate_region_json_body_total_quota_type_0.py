...
class RhubapilabregioncreateRegionJsonBodyTotalQuotaType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabregioncreate_region_json_body_total_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabregioncreate_region_json_body_total_quota_type_0.additional_properties = d
        return rhubapilabregioncreate_region_json_body_total_quota_type_0
