...
T = TypeVar("T", bound="RhubApiLabRegionGetRegionResponse200UserQuota")


@attr.s(auto_attribs=True)
class RhubApiLabRegionGetRegionResponse200UserQuota:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_get_region_response_200_user_quota = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_region_get_region_response_200_user_quota.additional_properties = d
        return rhub_api_lab_region_get_region_response_200_user_quota
