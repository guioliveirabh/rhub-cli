...
class RhubapilabregionlistRegionProductsResponse200ItemProductFlavorsAdditionalProperty:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabregionlist_region_products_response_200_item_product_flavors_additional_property = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabregionlist_region_products_response_200_item_product_flavors_additional_property.additional_properties = (
            d
        )
        return rhubapilabregionlist_region_products_response_200_item_product_flavors_additional_property
