...
T = TypeVar("T", bound="RhubApiLabRegionListRegionsResponse200DataItemTotalQuota")


@attr.s(auto_attribs=True)
class RhubApiLabRegionListRegionsResponse200DataItemTotalQuota:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhub_api_lab_region_list_regions_response_200_data_item_total_quota = cls(
            num_vcpus=num_vcpus,
        ...
        rhub_api_lab_region_list_regions_response_200_data_item_total_quota.additional_properties = d
        return rhub_api_lab_region_list_regions_response_200_data_item_total_quota
