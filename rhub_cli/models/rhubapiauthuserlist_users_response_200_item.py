...
from ..models.rhubapiauthuserlist_users_response_200_item_id import RhubapiauthuserlistUsersResponse200ItemId
...
class RhubapiauthuserlistUsersResponse200Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapiauthuserlist_users_response_200_item = cls(
            email=email,
            enabled=enabled,
        ...
        rhubapiauthuserlist_users_response_200_item.additional_properties = d
        return rhubapiauthuserlist_users_response_200_item
