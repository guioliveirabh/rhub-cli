...
class RhubapilabclusterrebootHostsJsonBodyHostsType1Item:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclusterreboot_hosts_json_body_hosts_type_1_item = cls(
            fqdn=fqdn,
            id=id,
        )

        rhubapilabclusterreboot_hosts_json_body_hosts_type_1_item.additional_properties = d
        return rhubapilabclusterreboot_hosts_json_body_hosts_type_1_item
