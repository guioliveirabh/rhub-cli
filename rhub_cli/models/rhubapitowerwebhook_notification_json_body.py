...
class RhubapitowerwebhookNotificationJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapitowerwebhook_notification_json_body = cls(
            body=body,
        ...
        rhubapitowerwebhook_notification_json_body.additional_properties = d
        return rhubapitowerwebhook_notification_json_body
