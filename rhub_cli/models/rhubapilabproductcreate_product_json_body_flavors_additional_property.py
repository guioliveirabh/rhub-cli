...
class RhubapilabproductcreateProductJsonBodyFlavorsAdditionalProperty:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabproductcreate_product_json_body_flavors_additional_property = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabproductcreate_product_json_body_flavors_additional_property.additional_properties = d
        return rhubapilabproductcreate_product_json_body_flavors_additional_property
