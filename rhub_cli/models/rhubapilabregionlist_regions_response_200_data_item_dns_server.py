...
class RhubapilabregionlistRegionsResponse200DataItemDnsServer:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabregionlist_regions_response_200_data_item_dns_server = cls(
            hostname=hostname,
            key=key,
            zone=zone,
        )

        rhubapilabregionlist_regions_response_200_data_item_dns_server.additional_properties = d
        return rhubapilabregionlist_regions_response_200_data_item_dns_server
