...
from ..models.rhubapilabclustercreate_cluster_json_body_quota_usage_type_0 import (
...
class RhubapilabclustercreateClusterJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclustercreate_cluster_json_body = cls(
            created=created,
        ...
        rhubapilabclustercreate_cluster_json_body.additional_properties = d
        return rhubapilabclustercreate_cluster_json_body
