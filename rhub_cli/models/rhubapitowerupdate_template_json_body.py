...
from ..models.rhubapitowerupdate_template_json_body_id import RhubapitowerupdateTemplateJsonBodyId
...
class RhubapitowerupdateTemplateJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapitowerupdate_template_json_body = cls(
        ...
        rhubapitowerupdate_template_json_body.additional_properties = d
        return rhubapitowerupdate_template_json_body
