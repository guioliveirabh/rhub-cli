...
from ..models.rhubapitowerlist_templates_response_200_data_item_id import RhubapitowerlistTemplatesResponse200DataItemId
...
class RhubapitowerlistTemplatesResponse200DataItem:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapitowerlist_templates_response_200_data_item = cls(
        ...
        rhubapitowerlist_templates_response_200_data_item.additional_properties = d
        return rhubapitowerlist_templates_response_200_data_item
