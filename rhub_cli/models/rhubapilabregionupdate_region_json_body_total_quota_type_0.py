...
class RhubapilabregionupdateRegionJsonBodyTotalQuotaType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabregionupdate_region_json_body_total_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabregionupdate_region_json_body_total_quota_type_0.additional_properties = d
        return rhubapilabregionupdate_region_json_body_total_quota_type_0
