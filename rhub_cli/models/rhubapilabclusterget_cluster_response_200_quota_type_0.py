...
class RhubapilabclustergetClusterResponse200QuotaType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclusterget_cluster_response_200_quota_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabclusterget_cluster_response_200_quota_type_0.additional_properties = d
        return rhubapilabclusterget_cluster_response_200_quota_type_0
