...
class RhubapilabclusterupdateClusterResponse200QuotaUsageType0:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapilabclusterupdate_cluster_response_200_quota_usage_type_0 = cls(
            num_vcpus=num_vcpus,
        ...
        rhubapilabclusterupdate_cluster_response_200_quota_usage_type_0.additional_properties = d
        return rhubapilabclusterupdate_cluster_response_200_quota_usage_type_0
