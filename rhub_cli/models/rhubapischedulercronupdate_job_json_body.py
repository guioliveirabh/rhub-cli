...
class RhubapischedulercronupdateJobJsonBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rhubapischedulercronupdate_job_json_body = cls(
        ...
        rhubapischedulercronupdate_job_json_body.additional_properties = d
        return rhubapischedulercronupdate_job_json_body
